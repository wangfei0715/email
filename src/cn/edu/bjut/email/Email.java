...
public class Email {
	...
	public static void main(String[] args) {
		 ...
		 ************* 切切注意********
		 */
		Email themail = new Email("smtp.sina.com", "super53112", "19860715");// 这里以新浪邮箱为例子
		String mailbody = "孟老师测试邮件正文";// 邮件正文
		themail.setNeedAuth(true);
		themail.setSubject("孟老师测试邮件标题带附件");// 邮件主题
		themail.setBody(mailbody);// 邮件正文
		themail.setTo("915105763@qq.com");// 收件人地址
		themail.setFrom("super53112@sina.com");// 发件人地址
		themail.addFileAffix("c:/en_movie.txt");// 附件文件路径,例如：C:/222.jpg,*注；"/"的写法；
		// 如果没有可以不写
		// themail.setNamePass("friendxxy@sina.com", "*******");// 发件人地址和密码
		// **改为相应邮箱密码
		themail.sendout();
	}
}
